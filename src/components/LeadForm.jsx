  ...
  const submit = async (event) => {
    ...
    if (!serviceId || !templateId || !publicKey) {
      setStatus({
        type: 'error',
        message:
          'Email notifications are not configured yet. Please contact the site administrator.',
      })
      return
    }
    ...
    try {
      ...
      const templateParams = {
        email_subject: `NEW AFH LEAD • ${financingTitle} • ${form.name.trim()} • ${amountRequested}`,
